...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Digisign/input_Wahyu Hidayat_395903'), 'hAK8SnwY1zie88hMtHSBSQ==')

WebUI.click(findTestObject('Object Repository/Page_Digisign/button_Sign in'))

WebUI.verifyElementPresent(findTestObject('Page_Digisign/b_Password Salah'), 0)

WebUI.verifyElementPresent(findTestObject('Page_Digisign/div_Password Salah'), 0)
